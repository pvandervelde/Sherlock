...
namespace Sherlock.Service.Executor.Nuclei
{
    /// <summary>
    ...
    internal sealed class UtilitiesModule : Autofac.Module
    {
        ...
        /// </summary>
        private const string DefaultInfoFileName = "service.executor.info.log";

        /// <summary>
        /// The default name for the profiler log.
        /// </summary>
        private const string DefaultProfilerFileName = "service.executor.profile";
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            // Register the global application objects
            {
                ...
                builder.Register(c => new XmlConfiguration(
                        ExecutorServiceConfigurationKeys.ToCollection()
                            .Append(CommunicationConfigurationKeys.ToCollection())
                            .Append(DiagnosticsConfigurationKeys.ToCollection())
                            .ToList(),
                        ExecutorServiceConstants.ConfigurationSectionApplicationSettings))
                    .As<IConfiguration>()
                    .SingleInstance();
