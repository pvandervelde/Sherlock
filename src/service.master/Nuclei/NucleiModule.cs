...
namespace Sherlock.Service.Master.Nuclei
{
    /// <summary>
    ...
    internal sealed class NucleiModule : Autofac.Module
    {
        ...
        /// </summary>
        private const string DefaultInfoFileName = "service.master.info.log";

        /// <summary>
        /// The default name for the profiler log.
        /// </summary>
        private const string DefaultProfilerFileName = "service.master.profile";
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            // Register the global application objects
            {
                ...
                builder.Register(c => new XmlConfiguration(
                        MasterServiceConfigurationKeys.ToCollection()
                            .Append(CommunicationConfigurationKeys.ToCollection())
                            .Append(DiagnosticsConfigurationKeys.ToCollection())
                            .ToList(),
                        MasterServiceConstants.ConfigurationSectionApplicationSettings))
                    .As<IConfiguration>()
                    .SingleInstance();
