...
{
    /// <content>
    /// Defines the public API part for the test step report directory class.
    /// </content>
    [Serializable]
    public sealed partial class TestStepReportDirectory
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the ID of the test step report directory.
        /// </summary>
        public int Id
        {
            get
            {
                return pk_TestStepReportDirectoryId;
            }
        }

        /// <summary>
        /// Gets or sets the ID of the test step that the current report directory is linked to.
        /// </summary>
